...
public class LoginSD {
    ...
    @When("^I enter (.+) into (username|password|firstname|lastname|email|mobile number|new password) text fields on home screen$")
    public void enterDataIntoTextFields(String anyText, String textFields) {
        ...
        switch (textFields) {
            ...
            case "mobile number":
                ...
                //if(homePage.isElementDisplayed())
                break;
            case "new password":
    ...
    @When("^I click on (new password) button on home screen$")
    public void clickOnNewPassword() { homePage.clickOnNewPassword();}

    @When("^I click on (red warning button) button on home screen$")
    public void clickOnRedWarning() {homePage.clickOnRedWarning();}
    ...
    public void verifyInvalidEmailErrorMessage() {
        Assert.assertEquals(homePage.getInvalidEmailErrorMessage(), "Please enter a valid mobile number or email address.");
    }
}
